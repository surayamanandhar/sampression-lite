            ...
            <div id="interaction-sec" class="clearfix">
                ...
                <ul class="sm-top">
					...
					if ( get_theme_mod( 'sampression_socials_facebook', $fb_icon ) ) { ?>
                        <li class="sm-top-fb"><a class="genericon-facebook-alt"
                                                 href="<?php echo stripslashes( get_theme_mod( 'sampression_socials_facebook', $fb_icon ) ); ?>"
                                                 target="_blank"></a></li>
					<?php }
					// Twitter
					$tw_icon = '';
					...
					if ( get_theme_mod( 'sampression_socials_twitter', $tw_icon ) ) {
						?>
                        <li class="sm-top-tw"><a class="genericon-twitter"
                                                 href="<?php echo stripslashes( get_theme_mod( 'sampression_socials_twitter', $tw_icon ) ); ?>"
                                                 target="_blank"></a></li>
					<?php }
					// Google plus
					$gp_icon = '';
					...
					if ( get_theme_mod( 'sampression_socials_googleplus', $gp_icon ) ) {
						?>
                        <li class="sm-top-gplus"><a class="genericon-googleplus"
                                                    href="<?php echo stripslashes( get_theme_mod( 'sampression_socials_googleplus', $gp_icon ) ); ?>"
                                                    target="_blank"></a></li>
					<?php }
					// Youtube
					$yt_icon = '';
					...
					if ( get_theme_mod( 'sampression_socials_youtube', $yt_icon ) ) {
						?>
                        <li class="sm-top-youtube"><a class="genericon-youtube"
                                                      href="<?php echo stripslashes( get_theme_mod( 'sampression_socials_youtube', $yt_icon ) ); ?>"
                                                      target="_blank"></a></li>
					<?php }
					// Tumblr
					if ( get_theme_mod( 'sampression_socials_tumblr' ) ) {
						?>
                        <li class="sm-top-tumblr"><a class="genericon-tumblr"
                                                     href="<?php echo stripslashes( get_theme_mod( 'sampression_socials_tumblr' ) ); ?>"
                                                     target="_blank"></a></li>
						<?php
					}
					// Pinterest
					if ( get_theme_mod( 'sampression_socials_pinterest' ) ) {
						?>
                        <li class="sm-top-pinterest"><a class="genericon-pinterest"
                                                        href="<?php echo stripslashes( get_theme_mod( 'sampression_socials_pinterest' ) ); ?>"
                                                        target="_blank"></a></li>
						<?php
					}
					// Linkedin
					if ( get_theme_mod( 'sampression_socials_linkedin' ) ) {
						?>
                        <li class="sm-top-linkedin"><a class="genericon-linkedin"
                                                       href="<?php echo stripslashes( get_theme_mod( 'sampression_socials_linkedin' ) ); ?>"
                                                       target="_blank"></a></li>
						<?php
					}
					// Github
					if ( get_theme_mod( 'sampression_socials_github' ) ) {
						?>
                        <li class="sm-top-github"><a class="genericon-github"
                                                     href="<?php echo stripslashes( get_theme_mod( 'sampression_socials_github' ) ); ?>"
                                                     target="_blank"></a></li>
						<?php
					}
					// Instagram
					if ( get_theme_mod( 'sampression_socials_instagram' ) ) {
						?>
                        <li class="sm-top-instagram"><a class="genericon-instagram"
                                                        href="<?php echo stripslashes( get_theme_mod( 'sampression_socials_instagram' ) ); ?>"
                                                        target="_blank"></a></li>
						<?php
					}
					// Flickr
					if ( get_theme_mod( 'sampression_socials_flickr' ) ) {
						?>
                        <li class="sm-top-flickr"><a class="genericon-flickr"
                                                     href="<?php echo stripslashes( get_theme_mod( 'sampression_socials_flickr' ) ); ?>"
                                                     target="_blank"></a></li>
						<?php
					}
					// Vimeo
					if ( get_theme_mod( 'sampression_socials_vimeo' ) ) {
						?>
                        <li class="sm-top-vimeo"><a class="genericon-vimeo"
                                                    href="<?php echo stripslashes( get_theme_mod( 'sampression_socials_vimeo' ) ); ?>"
                                                    target="_blank"></a></li>
						<?php
					}
					?>
...
<?php if ( is_home() ): ?>
        ...
        <div class="container">
            ...
            <div class="columns twelve">
                ...
                <ul class="nav-listing clearfix" id="filter">
                    <li><a href="#" class="active selected" data-filter="*"
                           data-group="all"><span></span><?php _e( 'Show All', 'sampression-lite' ); ?></a></li>
					<?php
					...
					foreach ( $categories as $category ):
						?>
                        <li><a href="#" data-filter=".<?php echo $category->slug; ?>"
                               data-group="<?php echo $category->slug; ?>"
                               id="<?php echo $category->slug; ?>"><span></span><?php echo $category->name; ?></a></li>
						<?php
					endforeach;
					?>
                </ul>
    ...
    <div class="menu-sapce"></div>
    <!-- TODO: navigation borderbottom and boxshadow need to be fixed as per the design -->
    <!-- #primary-nav -->
<?php endif; ?>
