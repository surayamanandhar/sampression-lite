...
( function( $ ) {
	...
	wp.customize( 'link_color', function( value ) {
		value.bind( function( to ) {
            //console.log(to);
            $('a:link, a:visited, .meta, .meta a, #top-nav ul a:link, #top-nav ul a:visited, #primary-nav ul.nav-listing li a, .post-author:before, .posted-on:before, 
            .edit:before, .cats:before, .tags:before, .cats:before, .count-comment:before').not('#site-title a, article.post .post-title a, .sm-top a').css({'color' : to });
