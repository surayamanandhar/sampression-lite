...
( function( $ ) {
	...
	wp.customize( 'title_font', function( value ) {
		value.bind( function( to ) {
			sampression_font_family( '#site-title a, article.post .post-title a, body.single article.post .post-title, body.page article.post .post-title', to );
		});
	});
	...
	wp.customize( 'body_font', function( value ) {
		value.bind( function( to ) {
			sampression_font_family( 'body, p', to );			
		});
	});
