jQuery(document).ready(function() {
	...
	jQuery('.wp-full-overlay-sidebar-content').prepend('<a style="width: 80%; margin: 5px auto 5px auto; display: block; text-align: center;" href="http://www.sampression.com/themes/sampression-pro/" class="button" target="_blank">{pro}</a>'.replace('{pro}',objectL10n.pro));
