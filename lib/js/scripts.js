...
// =============================================================
    $('#btn-nav-opt').click(function () {
        ...
        $('#content-wrapper').animate({'padding-top': 20}); /* Resets the padding top every time when it clicked */
        if ($(this).hasClass('up')) {
        ...
        if ($('body').hasClass('home')) { 	// enable sticky menu only on homepage
            $(window).scroll(function () {
                if ($(window).scrollTop() > getTotalHt('#header')) {
                    ...
                    if ($("#btn-nav-opt").hasClass('up')) {
                        $('#content-wrapper').css('padding-top', ulHt + 56);
                    } else {
                        $('#content-wrapper').css('padding-top', navHeight + 20);
                    }
